...
#if defined COHESIVE_BED || defined SED_BIODIFF || defined MIXED_BED
      counter2 = counter2+1
      idoff    = counter2    ! Offset for calculation of dmix erodibility
      counter2 = counter2+1      profile (m).                            
      idslp    = counter2    ! Slope  for calculation of dmix or erodibility
      counter2 = counter2+1      profile.                                   
